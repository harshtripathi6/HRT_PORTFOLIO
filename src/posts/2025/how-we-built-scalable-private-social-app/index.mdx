...
> ![Architecture](./assets/02-architecture.png) > _“A high-level diagram illustrating the AWS load balancer distributing traffic to three Node.js microservices, connected to a self-managed Postgres instance with Redis caching.”_
...
> ![Pipeline](./assets/03-pipeline.png) > _“An illustrative flowchart of how code is built, tested, and deployed to AWS t3.medium instances.”_
